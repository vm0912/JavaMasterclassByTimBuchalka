package JavaIO.WritingSequentiallyChallenge;
...
//            System.out.println("int3 = " + readBuffer.getInt());
            ...
            //CHALLENGE: read the integers in reverse order
            System.out.println("Reading in reverse...");
            System.out.println("last int = " +readBuffer.getInt((int)int3Pos));
            System.out.println("int before that = " + readBuffer.getInt((int) int2Pos));
            System.out.println("int before that = " + readBuffer.getInt((int) int1Pos));
