...
/*
Fix the code by finding the problem and resolving it.
SOLUTION: The problem is occurrence of livelock; the threads are active, but don't do any useful job, the lock.unlock() method
wasn't called at all so it had to be fixed.
 */
